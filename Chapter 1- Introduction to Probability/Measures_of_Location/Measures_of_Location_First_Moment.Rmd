...
hist(Age,col="lightblue",xlab="Age (years)",ylab=NULL,main=NULL,breaks=300,cex=0.5) # Histogram of the 7 numbers
abline(v=mean(Age),col="blue",lwd=3)# line indicating the mean
abline(v=median(Age),col="green",lwd=3)# line indicating the mean
abline(v=Mode(Age),col="red",lwd=3)# line indicating the mean
legend("topright",c("mean","median","mode"),lwd=c(3,3,3),lty=c(1,1,1),col=c("blue","green","red"))
#dev.off()
library(ggplot2)
Age<-c(rnorm(2000,10,1.5),rnorm(1000,40,6))
